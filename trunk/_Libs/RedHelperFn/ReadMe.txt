========================================================================
    STATIC LIBRARY : RedHelperFn Project Overview
========================================================================

AppWizard has created this RedHelperFn library project for you.

This file contains a summary of what you will find in each of the files that
make up your RedHelperFn application.
...
StdAfx.h, StdAfx.cpp
    ...
    named RedHelperFn.pch and a precompiled types file named StdAfx.obj.
...
project, including "resource.h", "RedHelperFn.rc" and a "RedHelperFn.h" that
