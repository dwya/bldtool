========================================================================
    ACTIVE TEMPLATE LIBRARY : ProjSrv Project Overview
========================================================================

AppWizard has created this ProjSrv project for you to use as the starting point for
...
ProjSrv.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (ProjSrv.h)
        GUID definitions                                (ProjSrv_i.c)
        A type library                                  (ProjSrv.tlb)
        Marshaling code                                 (ProjSrv_p.c and dlldata.c)

ProjSrv.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in ProjSrv.idl. It will be regenerated by MIDL during compilation.
...
StdAfx.h, StdAfx.cpp
    ...
    named ProjSrv.pch and a precompiled types file named StdAfx.obj.
...
ProjSrvps.vcproj
	...
	dlldata.c, ProjSrv_i.c and ProjSrv_p.c which are required
